...
export const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/components/icon', name: 'icon', label: 'Icon' },
      { path: '/components/icon-button', name: 'icon-button', label: 'IconButton' },
      { path: '/components/switch', name: 'switch', label: 'Switch' },
      { path: '/components/tab-bar', name: 'tab-bar', label: 'TabBar' },
      { path: '/components/sheet', name: 'sheet', label: 'Sheet' },
      { path: '/components/page-header', name: 'page-header', label: 'PageHeader' },
      { path: '/components/fab', name: 'fab', label: 'Fab' },
...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/components/icon', component: () => import('./views/IconView.vue') },
    ...
    { path: '/components/tab-bar', component: () => import('./views/TabBarView.vue') },
    { path: '/components/sheet', component: () => import('./views/SheetView.vue') },
    { path: '/components/page-header', component: () => import('./views/PageHeaderView.vue') },
    { path: '/components/fab', component: () => import('./views/FabView.vue') },
